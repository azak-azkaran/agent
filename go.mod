module github.com/azak-azkaran/agent
...
require (
	...
	github.com/visualfc/fastmod v1.3.3 // indirect
	github.com/visualfc/gocode v1.1.0 // indirect
	github.com/zalando/skipper v0.11.111 // indirect
